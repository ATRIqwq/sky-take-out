...
* @createDate 2024-04-10 12:32:01
*/
@Service
@Slf4j
public class OrdersServiceImpl extends ServiceImpl<OrdersMapper, Orders>
    ...
    public OrderSubmitVO submitOrder(OrdersSubmitDTO ordersSubmitDTO) {
        ...
        queryWrapper.lambda().eq(ShoppingCart::getUserId,userId);
...
//                List<OrderDetail> orderDetails = orderDetailMapper.getByOrderId(orderId);
                ...
                wrapper.lambda().eq(OrderDetail::getOrderId,orderId);
     ...
     */
    @Override
    public OrderVO detailsList(Long id) {
        Orders orders = ordersMapper.selectById(id);
        Long ordersId = orders.getId();

        QueryWrapper<OrderDetail> wrapper = new QueryWrapper<>();
        wrapper.lambda().eq(OrderDetail::getOrderId,ordersId);
        List<OrderDetail> orderDetails = orderDetailMapper.selectList(wrapper);
